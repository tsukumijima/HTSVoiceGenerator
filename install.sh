...
# パッケージのインストール
sudo apt-get update
sudo apt-get -y install build-essential autoconf sox libsox-fmt-all libpulse-dev libasound-dev hts-voice-nitech-jp-atr503-m001 cmake csh libx11-dev flac jq
